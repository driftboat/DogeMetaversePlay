...
public class BMath
{
    ...
    public static  readonly  float3 top = new float3(0,1,0);
    public static  readonly  float3 bottom = new float3(0,-1,0);
    public static  readonly  float3 front = new float3(0,0,1);
